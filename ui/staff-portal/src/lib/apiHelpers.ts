...
/**
 * Formats an ISO date string (YYYY-MM-DD or ISO datetime) as "May 18, 2026".
 * Parses date-only portion to avoid timezone-offset shifting.
 */
...
/**
 * Formats an ISO datetime string as "May 18, 2026 2:47 AM".
 */
